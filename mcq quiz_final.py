...
correct_answers_currentaffairs=[1,2,1,0,2,3,3,1,1,0,0,1,3,2,0]
...
movie_questions=[".Which is the first Indian movie submitted for Oscar?",
                ...
                ".Who is called as 'Challenging Star' in sandelwood industry?",
...
sports_questions=[".Which country will host the upcoming cricket world cup?",
                  ...
                  ".Rugby is a Natioal Game of which country?",
...
answers_sports=[["England","Australia","South Africa","India"],
                ...
                ["Messi","Ronaldo","sergio Romez","marcelo"],
